#! /bin/bash
sum=0
image_save_path="/home/hbc/data/yolo/results/image/"
txt_save_path="/home/hbc/data/yolo/results/txt/"
for file in /home/hbc/smartcity/images/dataset1/Cam1/*.jpg
do
    if test -f $file
    then
        let "sum += 1"
